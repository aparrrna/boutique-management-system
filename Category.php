...
<head>
    <title>Online Boutique Store</title>
...
<div id="content">
    ...
    <table width="100%" border="0" cellspacing="3" cellpadding="3">
        ...
        <tr>
            <td><p><img src="img/vacation1.jpg" alt="box" width="100" height="100" hspace="10" align="left"
                      class="imgleft" title="box"/></p></td>
            <td><p><img src="img/winter1.jpg" alt="box" width="100" height="100" hspace="10" align="left"
                      class="imgleft" title="box"/></p></td>
            <td><p><img src="img/met1.jpg" alt="box" width="100" height="100" hspace="10" align="left"
                      class="imgleft" title="box"/></p></td>
        </tr>
        <tr>
            <td height="26" bgcolor="#BCE0A8"><div align="center" class="style9">vacation</div></td>
            <td bgcolor="#BCE0A8"><div align="center" class="style9">winter</div></td>
            <td bgcolor="#BCE0A8"><div align="center" class="style9">met</div></td>
        </tr>
    </table>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
