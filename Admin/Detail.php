...
if (!function_exists("GetSQLValueString")) {
    ...
    {
        $theValue = (is_object($con) && method_exists($con, 'real_escape_string')) ? $con->real_escape_string($theValue) : addslashes($theValue);
...
mysqli_select_db($con, $database_shop);
$query_Recordset1 = sprintf("SELECT CustomerName, Address, City, Email, Mobile, Gender FROM customer_registration WHERE CustomerId = %s", GetSQLValueString($con, $colname_Recordset1, "int"));
        ...
        <div id="content">
            ...
            <table width="100%" border="0">
                <tr>
                    ...
                    <td bgcolor="#BDE0A8"><?php echo $row_Recordset1['CustomerName']; ?></td>
                </tr>
                <tr>
                    <td bgcolor="#E3F2DB"><strong>Address</strong></td>
                    <td bgcolor="#E3F2DB"><?php echo $row_Recordset1['Address']; ?></td>
                </tr>
                <tr>
                    <td bgcolor="#BDE0A8"><strong>City</strong></td>
                    <td bgcolor="#BDE0A8"><?php echo $row_Recordset1['City']; ?></td>
                </tr>
                <tr>
                    <td bgcolor="#E3F2DB"><strong>Email</strong></td>
                    <td bgcolor="#E3F2DB"><?php echo $row_Recordset1['Email']; ?></td>
                </tr>
                <tr>
                    <td bgcolor="#BDE0A8"><strong>Mobile</strong></td>
                    <td bgcolor="#BDE0A8"><?php echo $row_Recordset1['Mobile']; ?></td>
                </tr>
                <tr>
